  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          <strong>E-mail:</strong> mohammed.motar10@gmail.com
        </p>
        <p>
          <strong>Extra authorization:</strong> B driving license and access to
          car
        </p>
      </div>
      ...
      <div>
        <h3>EDUCATION</h3>
        <p>
          <strong>High school education:</strong> NTI-Gymnasiet, Kristianstad
          2016 - 2019
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          ...
          I usually go to the gym or play football. During my free time when I'm
          not exercising, I usually hang out with friends or family.
        </p>
      </div>
